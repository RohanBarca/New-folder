...
import { Activity, ArrowLeft, UserRoundPlus, Construction } from 'lucide-react';

export default function PatientRegisterPlaceholder() {
  return (
      ...
      <main className="flex-grow flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-3xl p-8 border border-slate-200 shadow-soft-lg text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold text-[#17385E]">Patient Registration</h1>
            <p className="text-sm text-slate-500">
              Registration, patient intake form, and medical history setup will be integrated in upcoming development phases.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200/80 text-amber-800 text-xs flex items-center gap-2.5 text-left">
            ...
            <span>Intake questionnaire and registration workflow will be enabled in Phase 6.</span>
          </div>
